...
const SOURCE_DOMAIN = "https://www.mangaworldadult.com"

export class MangaworldAdult extends Source {
    constructor(cheerio: CheerioAPI) {
        super(cheerio)
    }

    get version(): string { return '0.1.0' }
    get name(): string { return 'Mangaworld Adult' }
    get description(): string { return 'Mangaworld Adult' }
    get author(): string { return 'karoku9' }
